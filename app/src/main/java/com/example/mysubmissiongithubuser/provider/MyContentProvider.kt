package com.example.mysubmissiongithubuser.provider
...
class MyContentProvider : ContentProvider() {
    ...
    companion object {
        const val AUTHORITY = "com.example.mysubmissiongithubuser"
        const val TABLE_NAME = "favorite_user"
        const val ID_FAVORITE_DATA_USER = 1
        val uriMatcher = UriMatcher(UriMatcher.NO_MATCH)

        init {
            uriMatcher.addURI(AUTHORITY, TABLE_NAME, ID_FAVORITE_DATA_USER)
        }
    }
